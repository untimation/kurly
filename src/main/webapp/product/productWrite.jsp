...
<body>
	...
	<div id="wrap" align="center">
		...
		<form method="post" enctype="multipart/form-data" name="frm">
			<table>
				<tr>
					<th class="text">상 품 명</th>
					<td><input type="text" name="productname" class="input"></td>
				</tr>
				<tr>
					<th class="text">가 격</th>
					<td><input type="text" name="price" class="input"> 원</td>
				</tr>
				<tr>
					<th class="text">사 진</th>
					<td><input type="file" name="pictureUrl" class="file"><br>
						(주의사항 : 이미지를 변경하고자 할때만 선택하시오)</td>
				</tr>
				<tr>
					<th class="text">설 명</th>
					<td><textarea cols="80" rows="10" name="description" class="content"></textarea></td>
				</tr>
			</table>
