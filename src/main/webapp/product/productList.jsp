...
<body>
	...
	<div id="wrap" align="center">
		...
		<table class="list">
			<tr>
				<td><input type="button" value="상품등록" class="wri_btn"
					onclick="location.href='productWrite.do'"></td>
			</tr>

			<tr>
				<th class="lists">목록</th>
			</tr>
			<c:forEach var="product" items="${productList}">
				<tr class="record">
					...
					<td><a href="productUpdate.do?code=${product.code}" class="a">상품
							수정</a></td>
					<td><a href="productDelete.do?code=${product.code}" class="a">상품
							삭제</a></td>
				</tr>
			</c:forEach>
		</table>
