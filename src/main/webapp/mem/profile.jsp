...
<body>
	<div class="headertop">
		<div class="bundle">
			...
			%>
			<a href="profile.do" class="join"><%=username%>님</a>
			<!-- 프로필 대신 사용자 이름 표시 -->
			<p>&#124;</p>
	...
	<div class="profile">
		<div class="L_pro">
			<div class="L_pro_1"></div>
			<div class="L_pro_2"></div>
			<div class="L_pro_3"></div>
			<div class="L_pro_4"></div>
		</div>
		<div class="R_pro">
			<div class="R_pro_1"></div>
			<div class="R_pro_2">
				<div class="R_pro_2-1"></div>
				<div class="R_pro_2-2"></div>
			</div>
		</div>
	</div>
	<footer>
