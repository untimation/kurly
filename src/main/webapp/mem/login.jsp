...
<body>
	...
	<div class="signup">
		...
		<div class="form">
			<%-- main start --%>
			<form action="login.do" method="post" name="frm" class="fom">
				<table class="login_table">
					<tr>
						<td class="id"><input type="text" name="userid" autofocus required
							placeholder="아이디를 입력해주세요" value="${userid}" class="id_bar"></td>
					</tr>
					<tr>
						<td class="pwd"><input type="password" name="pwd" autofocus required
							placeholder="비밀번호를 입력해주세요" class="id_bar"></td>
					</tr>
					<tr>
						<td class="find">
							<a href="#">비밀번호 찾기</a><a>&#124;</a><a href="#">아이디 찾기</a>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="center"><input type="submit"
							value="로그인" onclick="return loginCheck()" class="login_btn"> <input type="button" value="회원가입"
							onclick="location.href='join.do'" class="join_btn"></td>
					</tr>
					<tr>
