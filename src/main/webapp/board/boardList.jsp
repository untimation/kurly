...
<body>
	...
	<div id="wrap" align="center">
		...
		<h1 class="wrap_text">게시판</h1>
		<c:set var="admin" value="1" />
		<c:if test="${admin == 1}">
			<input type="button" onclick="location.href='productList.do'"
				class="hide_btn" value="관리자 페이지">
		</c:if>
		...
		<div class="list">
			...
			<c:forEach var="board" items="${boardList}">
				<a href="BoardServlet?command=board_view&num=${board.num}" class="a">
					<div class="record">
						<div>${board.num}</div>
						<div>${board.title}</div>
			...
			<div>
				<div colspan="5" style="border: white; text-align: right">
					<input type="button" value="목록" class="wri_btn"
