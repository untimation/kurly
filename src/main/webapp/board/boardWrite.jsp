...
<body>
	...
	<div id="wrap" align="center">
		<h1 class="post">게시글 작성</h1><hr class="line">
		...
		<form name="frm" method="post" action="BoardServlet">
			...
			<table>
				<tr>
					<th class="title">이름<span class="highlight">*</span></th>
					<td><input type="text" name="username" class="input" autofocus required placeholder="이름을 입력해주세요"></td>
				</tr>
				<tr>
					<th class="title">비번<span class="highlight">*</span></th>
					<td><input type="password" name="pass" class="input" autofocus required placeholder="글 삭제시 비밀번호가 필요합니다"></td>
				</tr>
				<tr>
					<th class="title">email</th>
					<td><input type="text" name="email" class="input" autofocus required placeholder="예: market@gmail.com"></td>
				</tr>
				<tr>
					<th class="title">제목<span class="highlight">*</span></th>
					<td><input type="text" size="70" name="title" class="input" autofocus required placeholder="제목을 입력해주세요"></td>
				</tr>
				<tr>
					<th class="title">내용<span class="highlight">*</span></th>
					<td><textarea cols="70" rows="15" name="content" class="content" autofocus required placeholder="내용을 입력해주세요"></textarea></td>
				</tr>
			</table>

			<br> <br> <input type="submit" value="등록"
				onclick="return boardCheck()" class="reg_btn"> <input type="reset"
				value="초기화" class="re_btn"> <input type="button" class="li_btn" value="목록"
